...
def main(page:Page):
   ...
   # page.padding = padding.only(top=30)
    ...
    def animate_getSpeedContainer(e:ControlEvent):
        getSpeedContainer.width = 700 if getSpeedContainer.width == 200 else 200
        getSpeedContainer.height = 400 if getSpeedContainer.height == 100 else 100
    ...
    # after line 3
    progress_bar = ProgressBar(width=400, color='#0080ff', bgcolor='white', opacity=0)
    ...
    progress_bar_02 = ProgressBar(width=400, color='#0080ff', bgcolor='white', opacity=0)
    progress_text:Text = Text(value="  ")
